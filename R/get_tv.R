#' get_tv
#' 
#' Crawlt Rundfunkveranstalter mit Zusatzinformationen von der RTR-Seite. Die 
#' Liste dient als Ausgangspunkt für die Funktion 'search_results'.
#' 
#' @param tv.url String, URL zu RTR-Rundfunkveranstaltern
#' @param ua 
#' @return data_frame (dplyr) mit Informationen zu den bei RTR gelisteten 
#'   Rundfunkveranstaler\*innen. Der Datensatz umfass dabei die Informationen
#'   \itemize{
